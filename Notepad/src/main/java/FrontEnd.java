...
public class FrontEnd extends javax.swing.JFrame {
    ...
    public boolean createNewFile(String strFilename) throws IOException {
        objFile = new File("/home/mr-attitude/Desktop/" + strFilename + ".txt");
        if (objFile.exists()) {
            return false;
        } else {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 890, 580));
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        try {
            ...
            if (!strContent.equals("")) {
                ...
                JOptionPane.showMessageDialog(rootPane, "File Sucessfully Saved");
            } else {
                JOptionPane.showMessageDialog(rootPane, "The File Can't be Found");
            }
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        try {
            ...
            if (booleanStatus) {
                JOptionPane.showMessageDialog(null,"File Created Sucessfully", "JNotePad", JOptionPane.ERROR_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(null,"File Already Exists", "JNotePad", JOptionPane.ERROR_MESSAGE);
            }
        } catch (IOException ex) {
           JOptionPane.showMessageDialog(null,ex.getMessage(), "JNotePad", JOptionPane.ERROR_MESSAGE);
        }
